        ...
        if ($this->validate($this->_validation_rules($id))) {
            ...
            if (!empty($_FILES['photo']['name'])) {
                ...
                if ($this->uploader->uploadTo('photo', $options)) {
                    ...
                    flash('danger', $this->uploader->getDisplayErrors(), '_back', 'photo/edit/'.$id);
                }
            }
            $this->db->trans_start();
            $this->page->update([
