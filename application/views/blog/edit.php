<form action="<?= site_url('blog/update/'.$blog['id']) ?>" method="POST" enctype="multipart/form-data" id="form-blog">
    <?= _csrf() ?>
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" maxlength="500" required
                        value="<?= set_value('title', $blog['title']) ?>" placeholder="Judul">
                <?= form_error('title') ?>
            </div>
            <div class="form-group">
                <label>Photo</label>
                ...
                <div class="input-group col-xs-12">
                    <input type="text" class="form-control file-upload-info" value="<?= $blog['photo'] ?>"disabled placeholder="Upload file">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor" id="body" name="body"
                          placeholder="Enter body"><?= set_value('body', $blog['body']) ?></textarea>
                <?= form_error('body') ?>
            </div>
            <div class="form-group">
                ...
                <select class="form-control select2" name="user" id="user" required data-placeholder="Select Writer">
                    ...
                    <?php foreach ($users as $user): ?>
                        <option value="<?= $user['id'] ?>"<?= set_select('user', $blog['writed_by'], $blog['writed_by'] == $user['id']) ?>>
                            <?= $user['name'] ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control datepicker" id="date" name="date" required
                        value="<?= set_value('date', $blog['date']) ?>" placeholder="tanggal">
                <?= form_error('date') ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="input-group col-xs-12">
                    <input type="text" class="form-control file-upload-info" value="<?= $blog['attachment'] ?>"disabled placeholder="Upload file">
                    <span class="input-group-append">
                        <button class="file-upload-browse btn btn-success btn-simple-upload" type="button">
                            Upload
                        </button>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="description" name="description" maxlength="500"
                          placeholder="Enter description"><?= set_value('description', $blog['description']) ?></textarea>
